...
export async function displayCurrencyWithDecimals(balance, decimals) {
  if (!balance) return 0;
  return ethers.utils.formatUnits(balance, decimals)
}
export function displayCurrencyWithDecimalsNonWaiting(balance, decimals) {
  if (!balance) return 0;
  return ethers.utils.formatUnits(balance, decimals)
}
...
export function expandToDecimals(value, decimals) {
